...
params = urllib.parse.urlencode({"query": input("Quel film aimeriez-vous regarder?"), "api_key": config['API_MDB']})

result = urllib.request.urlopen(f"https://api.themoviedb.org/3/movie?{params}")
